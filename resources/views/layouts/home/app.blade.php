...
<head>
  ...
  <body>
    @include('sweetalert::alert')
             ...
             <!-- Header -->
            @if(Request::is('about') || Request::is('contact') || Request::routeIs('home.single*')|| Request::is('lembaga')|| Request::is('legalitas')|| Request::is('kepengurusan'))
    ...
    <script>
            function copyText() {
                var textToCopy = document.querySelector('#norek').innerText;
