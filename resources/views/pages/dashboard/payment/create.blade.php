        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ url('dashboard/payment/table') }}">Table</a></div>
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text"
                                            class="form-control" id="name" name="name" placeholder="Your Payment Name.. ">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text"
                                            class="form-control" name="slug" id="slug" readonly>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number"
                                            class="form-control" id="norek" name="norek" placeholder="Your Nummber Of Rekening.. ">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
