                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ url('dashboard/payment/create') }}"
                                                ...
                                                <table class="table-striped table"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $payment->name }}</td>
                                                            <td>
                                                            <a class="btn btn-primary btn-action mr-2 mb-2" data-toggle="tooltip" title="Edit" href="{{ route('payment.edit', $payment->slug) }}"><i class="fas fa-pencil-alt"></i></a>
                                                            <form action="{{ route('payment.delete', $payment->id) }}" method="POST" class="delete-form" id="delete-form-{{ $payment->id }}">
                                                                @csrf
                                                                @method('DELETE')
