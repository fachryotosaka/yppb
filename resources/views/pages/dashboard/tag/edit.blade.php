        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    ...
                    <div class="breadcrumb-item"><a href="{{ url('dashboard/tag/table') }}">Table</a></div>
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text"
                                            class="form-control" id="name" value="{{ old('name', $tags->name) }}" name="name" placeholder="Your Tag Name.. ">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text"
                                            class="form-control" value="{{ old('slug', $tags->slug) }}" name="slug" id="slug" readonly>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
