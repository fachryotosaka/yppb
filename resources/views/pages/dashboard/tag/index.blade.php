                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ url('dashboard/tag/create') }}"
                                                ...
                                                <table class="table-striped table"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $tags->name }}</td>
                                                            <td>
                                                            <a class="btn btn-primary btn-action mr-2 mb-2" data-toggle="tooltip" title="Edit" href="{{ route('tag.edit', $tags->slug) }}"><i class="fas fa-pencil-alt"></i></a>
