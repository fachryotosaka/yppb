                                                ...
                                                <table class="table-striped table"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <a class="btn btn-primary btn-action mr-2 mb-2" data-toggle="tooltip" title="Edit" href="{{ route('publisher.restore', $publisher->id) }}"><i class="bi bi-recycle"></i></a>
